...
BoeSessionListener::BoeSessionListener(Deps deps)
    : deps_(std::move(deps))
{
    if (!deps_.queue)
...
{
    // Use steady_clock for monotonic measurements. If you prefer wall-clock, switch to system_clock.
...
void BoeSessionListener::onStateChange(
    OnixS::B3::BOE::SessionStateId::Enum /*newState*/,
...
void BoeSessionListener::onError(
    OnixS::B3::BOE::SessionErrorReason::Enum /*reason*/,
...
void BoeSessionListener::onWarning(
    OnixS::B3::BOE::SessionWarningReason::Enum /*reason*/,
    const std::string& /*description*/,
    OnixS::B3::BOE::Session* /*sn*/,
    OnixS::B3::BOE::Messaging::SbeMessage /*msg*/)
{
