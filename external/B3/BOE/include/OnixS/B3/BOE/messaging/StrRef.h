...
public:
    ...
    ONIXS_B3_BOE_NODISCARD
    ONIXS_B3_BOE_CONSTEXPR
    const Char* data() const ONIXS_B3_BOE_NOTHROW
    {
        return items_;
    }
    ...
    ONIXS_B3_BOE_NODISCARD
    ONIXS_B3_BOE_CONSTEXPR
    size_type size() const ONIXS_B3_BOE_NOTHROW
    {
        return size_;
    }
    ...
    size_type length() const ONIXS_B3_BOE_NOTHROW
    {
        return size_;
    }
    ...
    /// STL-like begin().
    ONIXS_B3_BOE_NODISCARD
    const_iterator begin() const ONIXS_B3_BOE_NOTHROW
    {
        assert(items_);
        return items_;
    }
    ...
    /// STL-like end().
    ONIXS_B3_BOE_NODISCARD
    const_iterator end() const ONIXS_B3_BOE_NOTHROW
    {
        assert(items_);
        return (items_ + size_);
    }
    ...
    /// STL-like cbegin().
    ONIXS_B3_BOE_NODISCARD
    const_iterator cbegin() const ONIXS_B3_BOE_NOTHROW
    {
        return begin();
    }
    ...
    /// STL-like cend().
    ONIXS_B3_BOE_NODISCARD
    const_iterator cend() const ONIXS_B3_BOE_NOTHROW
    {
        return end();
    }
    ...
    /// STL-like rbegin().
    ONIXS_B3_BOE_NODISCARD
    const_reverse_iterator rbegin() const ONIXS_B3_BOE_NOTHROW
    {
    ...
    /// STL-like rend().
    ONIXS_B3_BOE_NODISCARD
    const_reverse_iterator rend() const ONIXS_B3_BOE_NOTHROW
    {
    ...
    /// STL-like crbegin().
    ONIXS_B3_BOE_NODISCARD
    const_reverse_iterator crbegin() const ONIXS_B3_BOE_NOTHROW
    {
        return rbegin();
    }
    ...
    /// STL-like crend().
    ONIXS_B3_BOE_NODISCARD
    const_reverse_iterator crend() const ONIXS_B3_BOE_NOTHROW
    {
        return rend();
    }
    ...
    ONIXS_B3_BOE_NODISCARD
    const Char& operator [](size_type index) const ONIXS_B3_BOE_NOTHROW
    {
        assert(index < size_);
        assert(items_);
    ...
    const Char& front() const ONIXS_B3_BOE_NOTHROW
    {
        assert(!empty());
        return (*this)[0];
    }
    ...
    const Char& back() const ONIXS_B3_BOE_NOTHROW
    {
        assert(!empty());
        return (*this)[size_ - 1];
    }
    ...
    void swap(StrRef& other) ONIXS_B3_BOE_NOTHROW
    {
...
ONIXS_B3_BOE_NODISCARD StrRef toStrRef(const std::string&);
ONIXS_B3_BOE_NODISCARD StrRef toStrRef(const Char*) ONIXS_B3_BOE_NOTHROW;
...
ONIXS_B3_BOE_NODISCARD
inline StrRef toStrRef(const Char* cStr) ONIXS_B3_BOE_NOTHROW
{
    return
        (cStr != ONIXS_B3_BOE_NULLPTR) ?
        StrRef(cStr) :
        StrRef()
        ;
}
