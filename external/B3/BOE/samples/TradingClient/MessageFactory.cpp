...
namespace Samples {
  ...
  OrderCancelRequest MessageFactory::initOrderCancelRequest() const {
    ...
    msg->setSenderLocation(Location)
        .setEnteringTrader(EnteringTrader)
        .setMemo("ONIXS 123456789")
        .setDeskId(DeskId);
  ...
  NewOrderCross &MessageFactory::getNewOrderCross(const Order &buySideOrder,
                                                  const Order &sellSideOrder) const {
    ...
    buyEntry.setClOrdId(buySideOrder.cIOrdId_).setSide(buySideOrder.side_).setAccount(Account);

    sellEntry.setClOrdId(sellSideOrder.cIOrdId_).setSide(sellSideOrder.side_).setAccount(Account);
  ...
  SecurityDefinitionRequest MessageFactory::initSecurityDefinitionRequest() const {
    ...
    msg->setSenderLocation(Location).setEnteringTrader(EnteringTrader);
  ...
  SecurityDefinitionRequest &MessageFactory::getSecurityDefinitionRequest() const {
    ...
    legs[0].setLegSymbol("GOAU3").setLegRatioQty(RatioQty(1));
