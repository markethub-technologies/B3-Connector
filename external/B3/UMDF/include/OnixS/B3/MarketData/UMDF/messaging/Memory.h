...
ONIXS_B3_UMDF_MD_HOTPATH
ONIXS_B3_UMDF_MD_PURE
Type* advanceByBytes(Type* pointer, ptrdiff_t distance) ONIXS_B3_UMDF_MD_NOTHROW
{
    assert(pointer);
...
ONIXS_B3_UMDF_MD_HOTPATH
Value
extractValue(const void* location) ONIXS_B3_UMDF_MD_NOTHROW
{
    assert(location);
...
struct CompositeExtractor<1>
{
    ...
    static
    Value extract(const void* location) ONIXS_B3_UMDF_MD_NOTHROW
    {
...
getValue(const void* location) ONIXS_B3_UMDF_MD_NOTHROW
{
    assert(location);
