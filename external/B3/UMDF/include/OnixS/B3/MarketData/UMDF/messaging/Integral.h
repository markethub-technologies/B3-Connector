...
struct IntegralConstant
{
    ...
    /// \return value of the constant.
    ONIXS_B3_UMDF_MD_CONSTEXPR
    Value operator()() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        return Constant;
    }
    ...
    /// \return value of the constant.
    ONIXS_B3_UMDF_MD_CONSTEXPR
    static Value value() ONIXS_B3_UMDF_MD_NOTHROW
    {
        return Constant;
    }
};
...
ONIXS_B3_UMDF_MD_EXPORTED
ONIXS_B3_UMDF_MD_NODISCARD
bool fromStr(Int8&, const Char*, size_t) ONIXS_B3_UMDF_MD_NOTHROW;

/// Deserializes a numeric value from its text representation.
///
/// \return `true` if the given buffer contains a valid representation
/// of a number. Otherwise, `false` is returned.
inline ONIXS_B3_UMDF_MD_NODISCARD
bool fromStr(Int8& value, const std::string& str) ONIXS_B3_UMDF_MD_NOTHROW
{
    return
        fromStr(
            value,
...
fromStr(
    UInt8&,
    const Char*,
    size_t) ONIXS_B3_UMDF_MD_NOTHROW;
...
bool fromStr(
    UInt8& value,
    const std::string& str) ONIXS_B3_UMDF_MD_NOTHROW
{
    return
        fromStr(
            value,
