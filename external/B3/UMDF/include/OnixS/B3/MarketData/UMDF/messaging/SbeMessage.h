...
protected:
    ...
    /// otherwise - `false`.
    template < class Value, class NullValue > ONIXS_B3_UMDF_MD_HOTPATH
    bool ordinary(Value& value, BlockLength offset, NullValue null, SchemaVersion since) const ONIXS_B3_UMDF_MD_NOTHROW
    {
        return (since <= container().version()  && ordinary (value, offset, null ) );
    }

    /// \return the field value.
    template < class Enumeration > ONIXS_B3_UMDF_MD_HOTPATH
    typename Enumeration::Enum enumeration(BlockLength offset) const ONIXS_B3_UMDF_MD_NOTHROW
    {
    ...
    /// Provides access to an optional field value.
    template < class Enumeration, class NullValue > ONIXS_B3_UMDF_MD_HOTPATH
    bool enumeration(typename Enumeration::Enum& value, BlockLength offset, NullValue null) const ONIXS_B3_UMDF_MD_NOTHROW
    {
        typedef typename Enumeration::Base Base;
        typedef typename Enumeration::Enum Enum;
    ...
    /// Provides access to an optional field value.
    template < class Enumeration, class NullValue > ONIXS_B3_UMDF_MD_HOTPATH
    bool enumeration(typename Enumeration::Enum& value, BlockLength offset, NullValue null, SchemaVersion since) const ONIXS_B3_UMDF_MD_NOTHROW
    {
    ...
    template < class Value > ONIXS_B3_UMDF_MD_HOTPATH
    Value decimal(BlockLength offset) const ONIXS_B3_UMDF_MD_NOTHROW
    {
    ...
    /// otherwise - `false`.
    template < class Value, class NullValue > ONIXS_B3_UMDF_MD_HOTPATH
    bool decimal(Value& value, BlockLength offset, NullValue null) const ONIXS_B3_UMDF_MD_NOTHROW
    {
        value = ordinary<Value>(offset);
        return null != value;
    }
    ...
    /// otherwise - `false`.
    template < class Value, class NullValue > ONIXS_B3_UMDF_MD_HOTPATH
    bool decimal(Value& value, BlockLength offset, NullValue null, SchemaVersion since) const ONIXS_B3_UMDF_MD_NOTHROW
    {
        return (since <= container().version() && decimal(value, offset, null));
    }

    /// Provides access to a string field value.
    template < BlockLength Length > ONIXS_B3_UMDF_MD_HOTPATH
    StrRef fixedStr(BlockLength offset) const ONIXS_B3_UMDF_MD_NOTHROW
    {
    ...
    /// otherwise - `false`.
    template<BlockLength Length> ONIXS_B3_UMDF_MD_HOTPATH
    bool fixedStr(StrRef& value, BlockLength offset) const ONIXS_B3_UMDF_MD_NOTHROW
    {
    ...
    /// otherwise - `false`.
    template<BlockLength Length> ONIXS_B3_UMDF_MD_HOTPATH
    bool fixedStr(StrRef& value, BlockLength offset, SchemaVersion since) const ONIXS_B3_UMDF_MD_NOTHROW
    {
...
/// by descendants as a base class with static polymorphism.
template <class Container, class BlockLength >
ONIXS_B3_UMDF_MD_LTWT_CLASS SbeFields : public BinaryBlock<Container, BlockLength>
{
public:
    /// \return The block container that provides access to the encoded data.
    Container& container() ONIXS_B3_UMDF_MD_NOTHROW
    {
    ...
    void zeroPaddingBytes(BlockLength offset) ONIXS_B3_UMDF_MD_NOTHROW
    {
    ...
    template<class FieldValue> ONIXS_B3_UMDF_MD_HOTPATH
    void setOrdinary(BlockLength offset, FieldValue value) ONIXS_B3_UMDF_MD_NOTHROW
    {
    ...
    {
        if ONIXS_B3_UMDF_MD_UNLIKELY(since > container().version())
    ...
    /// Sets the field value.
    template<class Enumeration> ONIXS_B3_UMDF_MD_HOTPATH
    void setEnumeration(BlockLength offset, typename Enumeration::Enum value) ONIXS_B3_UMDF_MD_NOTHROW
    {
        typedef typename Enumeration::Base Base;
    ...
    /// Sets the field value.
    template<BlockLength Size> ONIXS_B3_UMDF_MD_HOTPATH
    void setFixedStr(BlockLength offset, StrRef value) ONIXS_B3_UMDF_MD_NOTHROW
    {
...
protected:
    /// Initializes a blank instance.
    SbeFields() ONIXS_B3_UMDF_MD_DEFAULT;
...
ONIXS_B3_UMDF_MD_LTWT_CLASS SbeGroupEntry : public SbeFields<SbeGroupEntry<BodySizeType>, BodySizeType>
{
public:
    ...
    /// Initializes a blank instance.
    SbeGroupEntry()
        : encoded_(ONIXS_B3_UMDF_MD_NULLPTR)
        , size_(0)
        , version_(0)
    {
    }
    ...
    bool valid() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        return (encoded_ != ONIXS_B3_UMDF_MD_NULLPTR);
    }

    /// \return the beginning of the group entry body.
    const void* encoded() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(valid());
    ...
    ///// \return the beginning of the group entry body.
    //void* encoded() ONIXS_B3_UMDF_MD_NOTHROW
    //{
    //    assert(valid());
    ...
    const void* block() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(valid());
    ...
    ///// \return the pointer to the block containing fixed-length fields.
    //void* block() ONIXS_B3_UMDF_MD_NOTHROW
    //{
    //    assert(valid());
    ...
    /// \return Block length.
    BlockLength blockLength() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        return size_;
    }

    /// \return SBE Schema version.
    SchemaVersion version() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        return version_;
    }
...
ONIXS_B3_UMDF_MD_LTWT_CLASS SbeGroupEntries
{
public:
    ...
    ONIXS_B3_UMDF_MD_LTWT_CLASS Iterator
    {
    public:
        typedef EntryType Entry;
        ...
        Iterator() ONIXS_B3_UMDF_MD_NOTHROW
            : entry_(ONIXS_B3_UMDF_MD_NULLPTR)
            , size_(0)
            , version_(0)
        {
        }
        ...
        ONIXS_B3_UMDF_MD_HOTPATH
        Iterator(void* entry, Size size, SchemaVersion version) ONIXS_B3_UMDF_MD_NOTHROW
            : entry_(entry)
            , size_(size)
            , version_(version)
        {
        ...
        bool valid() const ONIXS_B3_UMDF_MD_NOTHROW
        {
            return (entry_ != ONIXS_B3_UMDF_MD_NULLPTR);
        }
        ...
        /// Compares iterators.
        bool operator == (const Iterator& other) const ONIXS_B3_UMDF_MD_NOTHROW
        {
    ...
    SbeGroupEntries() ONIXS_B3_UMDF_MD_NOTHROW
        : encoded_(ONIXS_B3_UMDF_MD_NULLPTR)
        , blockLength_(0)
        , size_(0)
        , version_(0)
    ...
    SbeGroupEntries(void* encoded, BlockLength blockLength, Size groupSize, SchemaVersion version) ONIXS_B3_UMDF_MD_NOTHROW
        : encoded_(encoded)
    ...
    bool valid() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        return (ONIXS_B3_UMDF_MD_NULLPTR != encoded_);
    }
    ...
    Size size() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        return size_;
    }
    ...
    void* encoded() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        return encoded_;
    }

    /// \return the length of the binary data occupied by the group entries.
    EncodedLength encodedLength() const ONIXS_B3_UMDF_MD_NOTHROW
    {
    ...
    SbeGroupEntries(const SbeGroupEntries<OtherEntry, OtherBlockLength, OtherNumInGroup, OtherLength >& other) ONIXS_B3_UMDF_MD_NOTHROW
    ...
    template <class OtherEntry, class OtherBlockLength, class OtherNumInGroup, class OtherLength>
    SbeGroupEntries& operator = (const SbeGroupEntries <OtherEntry, OtherBlockLength, OtherNumInGroup, OtherLength>& other) ONIXS_B3_UMDF_MD_NOTHROW
    {
        encoded_ = other.encoded_;
...
ONIXS_B3_UMDF_MD_LTWT_CLASS SbeGroup
{
public:
    ...
    SbeGroup()
        ...
        : header_(ONIXS_B3_UMDF_MD_NULLPTR)
        , entries_(ONIXS_B3_UMDF_MD_NULLPTR)
        , version_(0)
    {
    }
    ...
    ONIXS_B3_UMDF_MD_HOTPATH
    SbeGroup(void* data, ONIXS_B3_UMDF_MD_UNUSED BinarySize size, SchemaVersion version) ONIXS_B3_UMDF_MD_NOTHROW
        : header_(static_cast <Dimension*>(data))
        , entries_(advanceByBytes(data, Dimension::Size))
        , version_(version)
    {
        ONIXS_B3_UMDF_MD_ASSERT(size >= Dimension::Size);
        assert(header_);
        assert(entries_);
    ...
    bool valid() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        return (entries_ != ONIXS_B3_UMDF_MD_NULLPTR);
    }
    ...
    ONIXS_B3_UMDF_MD_HOTPATH
    Iterator begin() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(valid());
    ...
    ONIXS_B3_UMDF_MD_HOTPATH
    Iterator end() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(valid());
    ...
    Entries entries() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(valid());
        assert(header_);
    ...
    const void* tail() const ONIXS_B3_UMDF_MD_NOTHROW
    {
    ...
    /// \return SBE-encoded data that represents the repeating group.
    ONIXS_B3_UMDF_MD_HOTPATH
    void* binary() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        return header_;
    }
    ...
    ONIXS_B3_UMDF_MD_HOTPATH
    BinarySize binarySize() const ONIXS_B3_UMDF_MD_NOTHROW
    {
    ...
    ONIXS_B3_UMDF_MD_HOTPATH
    EntrySize entrySize() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(valid());
        assert(header_);
...
private:
    ...
    void init(EntrySize entrySize) ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(valid());
        assert(header_);
    ...
    Size allocate(Size entryCount, const void* messageTail, const void* blockEnd)
    {
        ...
        if ONIXS_B3_UMDF_MD_UNLIKELY(byteDistance(blockEnd, newMessageTail) < 0)
            throwNotEnoughSpace();
...
ONIXS_B3_UMDF_MD_LTWT_CLASS SbeVariableLengthFieldList
{
public:
    /// Initializes the list over the given memory block.
    ONIXS_B3_UMDF_MD_HOTPATH
    SbeVariableLengthFieldList(void* binary, BinarySize size, SchemaVersion version) ONIXS_B3_UMDF_MD_NOTHROW
        : binary_(binary)
        , size_(size)
        , version_(version)
    {
    ...
    BinaryVariableLengthFieldType& head() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        return *static_cast<BinaryVariableLengthFieldType*>(binary_);
    }

    /// \return the list of variable-length fields following the head.
    template<class BinaryVariableLengthFieldType> ONIXS_B3_UMDF_MD_HOTPATH
    SbeVariableLengthFieldList tail() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(!empty());
    ...
    {
        if ONIXS_B3_UMDF_MD_UNLIKELY(empty() || (size_ < BinaryVariableLengthFieldType::Size))
        {
            throwBadBinaryBlock();
        }
        ...
        if ONIXS_B3_UMDF_MD_UNLIKELY(headSize > size_)
        {
            throwBadBinaryBlock();
        }
...
/// Groups list.
template  <class BinarySize>
ONIXS_B3_UMDF_MD_LTWT_CLASS SbeGroupList
{
public:
    /// Initializes the list over the memory block.
    ONIXS_B3_UMDF_MD_HOTPATH
    SbeGroupList(void* binary, BinarySize size, SchemaVersion version) ONIXS_B3_UMDF_MD_NOTHROW
        : binary_(binary)
        , size_(size)
        , version_(version)
    {
    ...
    template<class Group> ONIXS_B3_UMDF_MD_HOTPATH
    Group head() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(!empty());
    ...
    template<class Group> ONIXS_B3_UMDF_MD_HOTPATH
    SbeGroupList tail() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(!empty());
    ...
    template <class Group> ONIXS_B3_UMDF_MD_HOTPATH
    SbeVariableLengthFieldList<BinarySize> variableLengthFields() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(!empty());
...
private:
    ...
    {
        if ONIXS_B3_UMDF_MD_UNLIKELY(size_ < Group::Dimension::Size)
        {
            throwBadBinaryBlock();
        }
        ...
        if(!group.empty())
        {
            ...
            if ONIXS_B3_UMDF_MD_UNLIKELY(entrySize < expectedEntrySize)
            {
                throwBadBinaryBlock();
            }
        }
...
{
    if ONIXS_B3_UMDF_MD_UNLIKELY(version < Traits::MinimalVersion)
    {
...
void checkVersion(SchemaVersion since, SchemaVersion version)
{
    ...
    if ONIXS_B3_UMDF_MD_UNLIKELY(version < since)
    {
...
{
    if ONIXS_B3_UMDF_MD_UNLIKELY(id != Traits::Id)
    {
...
/// SBE-encoded message.
ONIXS_B3_UMDF_MD_LTWT_CLASS SbeMessage : public SbeFields<Messaging::SbeMessage, MessageSize>
{
public:
    ...
    /// Initializes a blank instance.
    SbeMessage() ONIXS_B3_UMDF_MD_NOTHROW
        : header_(ONIXS_B3_UMDF_MD_NULLPTR)
        , size_(0)
    {
    }
    ...
    //    if ONIXS_B3_UMDF_MD_UNLIKELY(size < MessageHeader::Size)
        ...
        , size_(size)
    {
        ...
        if ONIXS_B3_UMDF_MD_UNLIKELY(size < (MessageHeader::Size + header_->blockLength()))
    ...
    ONIXS_B3_UMDF_MD_HOTPATH
    SbeMessage(void* data, MessageSize size, NoCheck) ONIXS_B3_UMDF_MD_NOTHROW
        : header_(static_cast<MessageHeader*>(data))
        , size_(size)
    {
        assert(data);
    ...
    /// Blank the instance.
    void clear() ONIXS_B3_UMDF_MD_NOTHROW
    {
        *this = SbeMessage();
        assert(!valid());
    }
    ...
    bool valid() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        return (ONIXS_B3_UMDF_MD_NULLPTR != header_);
    }

    /// \return SBE Template identifier.
    MessageTemplateId templateId() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(valid());
    ...
    SchemaId schemaId() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(valid());
    ...
    const void* binary() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(valid());
    ...
    ///// \return SBE-encoded message content.
    //void* binary() ONIXS_B3_UMDF_MD_NOTHROW
    //{
    //    assert(valid());
    ...
    const void* blockEnd() ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(valid());
    ...
    // \return the end of the memory block.
    const void* blockEnd() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(valid());
    ...
    MessageSize bufferSize() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        return size_;
    }

    // /// \return the beginning of the message body.
    //void* body() ONIXS_B3_UMDF_MD_NOTHROW
    //{
    //    assert(valid());
...
protected:
    ...
    //SbeMessage& version(SchemaVersion version) ONIXS_B3_UMDF_MD_NOTHROW
    //{
    //    assert(valid());
    ...
    //ONIXS_B3_UMDF_MD_HOTPATH
    //GroupList groups() ONIXS_B3_UMDF_MD_NOTHROW
    //{
    //    assert(header_);
    ...
    /// \return the list of repeating groups
    ONIXS_B3_UMDF_MD_HOTPATH
    GroupList groups() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(header_);
    ...
    ONIXS_B3_UMDF_MD_HOTPATH
    void initGroup(Group& group, typename Group::EntrySize entrySize) ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(group.valid());
    ...
    //ONIXS_B3_UMDF_MD_HOTPATH
    //VariableLengthFieldList variableLengthFields() ONIXS_B3_UMDF_MD_NOTHROW
    //{
    //    assert(header_);
    ...
    /// \return the list of variable-length fields.
    ONIXS_B3_UMDF_MD_HOTPATH
    VariableLengthFieldList variableLengthFields() const ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(header_);
    ...
    //    SchemaId id) ONIXS_B3_UMDF_MD_NOTHROW
    //{
    //    assert(header_);
    ...
    ONIXS_B3_UMDF_MD_HOTPATH
    MessageSize calculateBinarySize(const void* tail) const ONIXS_B3_UMDF_MD_NOTHROW
    {
        assert(tail);
    ...
    {
        if ONIXS_B3_UMDF_MD_UNLIKELY(since > version())
            throwDisallowedField();
    ...
    template<class Callable, class Owner>
    StrRef getVariableLengthField(Callable callable, const Owner& owner) const ONIXS_B3_UMDF_MD_NOTHROW
    {
        ONIXS_B3_UMDF_MD_CHECK_NOTHROW(callable(owner));
        return callable(owner).varData();
    }

    /// \return the value of the variable length field.
    template<class Callable, class Owner>
    StrRef getVariableLengthField(Callable callable, SchemaVersion since, Owner& owner) const ONIXS_B3_UMDF_MD_NOTHROW
    {
        if ONIXS_B3_UMDF_MD_UNLIKELY(since > version())
            return StrRef();
    ...
    template<class Callable, class Owner>
    void setVariableLengthFieldToNull(Callable callable, Owner& owner) ONIXS_B3_UMDF_MD_NOTHROW
    {
        ONIXS_B3_UMDF_MD_CHECK_NOTHROW(callable(owner));
    ...
    void resetGroup(Callable callable, Owner& owner) ONIXS_B3_UMDF_MD_NOTHROW
    {
    ...
    template<class Callable, class Owner>
    void setVariableLengthFieldToNull(Callable callable, SchemaVersion since, Owner& owner) ONIXS_B3_UMDF_MD_NOTHROW
    {
        if ONIXS_B3_UMDF_MD_UNLIKELY(since > version())
            return;
    ...
    template<class Group, class Callable, class Owner>
    Group getGroup(Callable callable, Owner& owner) const ONIXS_B3_UMDF_MD_NOTHROW
    {
        ONIXS_B3_UMDF_MD_CHECK_NOTHROW(callable(owner));
    ...
    /// \return the repeating group.
    template<class Group, class Callable, class Owner>
    Group getGroup(Callable callable, SchemaVersion since, Owner& owner) const ONIXS_B3_UMDF_MD_NOTHROW
    {
        if ONIXS_B3_UMDF_MD_UNLIKELY(since > version())
            return Group();
    ...
    static MessageSize getMaxMessageSize() ONIXS_B3_UMDF_MD_NOTHROW
    {
        return
            MaxMessageSize;
    }
